...
class WordOnlyFilter {
  ...
  static const Set<String> _singleArabicLetters = {
    'أ', 'ا', 'إ', 'آ', 'ب', 'ت', 'ث', 'ج', 'ح', 'خ',
    'د', 'ذ', 'ر', 'ز', 'س', 'ش', 'ص', 'ض', 'ط', 'ظ',
    'ع', 'غ', 'ف', 'ق', 'ك', 'ل', 'م', 'ن', 'هـ', 'ه',
    'و', 'ي', 'ى', 'ئ', 'ء', 'ؤ', 'ة',
  };

  // الأسماء التقنية للأحرف في نماذج الـ Dataset
  static const Set<String> _technicalLetterNames = {
    'alef', 'ba2', 'ta2', 'tha2', 'jim', '7a2', 'kha2',
    'dal', 'thal', 'ra2', 'zayn', 'sin', 'chin', 'ssad',
    'ddad', 'tta2', 'ttha2', '3ayn', 'ghayn', 'fa2', '9af',
    'kaf', 'lam', 'mim', 'noon', 'ha2', 'waw', 'ya2',
    'space', 'delete', 'blank', 'no_sign', 'unknown', 'none',
  };
